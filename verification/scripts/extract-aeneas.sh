...
# Template only under aeneas-generated; filled models live at TqlmateExtract/FunsExternal.lean.
if [[ -f "$OUT/FunsExternal.lean" ]]; then
  mv "$OUT/FunsExternal.lean" "$OUT/FunsExternal_Template.lean"
fi
